...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" action="/message_board/AddEditMessageServlet?method=add" method="post">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <a class="btn btn-default" href="/message_board/MessageServlet?method=findAll">查看留言</a>
                    </div>
                </div>
            </form>
        </div>
